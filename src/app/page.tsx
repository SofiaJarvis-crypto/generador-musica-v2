...
.form-screen { max-width: 680px; margin: 0 auto; padding: 48px 24px 120px; }
...
.form-label {
  ...
  color: var(--text-dim); font-weight: 500; margin-bottom: 12px; display: block;
}
.input-field {
...
.genre-emoji { font-size: 28px; display: block; margin-bottom: 8px; }
...
.dur-pill {
  flex: 1; padding: 14px; background: var(--surface); border: 1.5px solid var(--border);
...
.generate-btn-note { text-align: center; font-size: 13px; color: var(--text-dim); margin-top: 14px; font-weight: 300; line-height: 1.5; }
...
@media (max-width: 640px) {
  ...
  .form-screen, .player-screen, .generating-screen, .success-screen { 
    padding-left: 16px; 
    padding-right: 16px;
    padding-bottom: 140px; /* Extra space for sticky button */
  }
  ...
  /* INPUT FIELDS - Taller, better spacing */
  .input-field {
    min-height: 56px;
    padding: 16px;
  ...
  .generate-btn-note {
    margin-bottom: 20px; /* Space before sticky button */
  }
  
  /* TESTIMONIAL - Mobile compact */
  .testimonial-quick {
    padding: 14px 16px;
    gap: 10px;
    margin-bottom: 28px;
